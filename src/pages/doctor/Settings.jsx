...
//             {/* Profile Update Card */}
//             <form onSubmit={handleDoctorSubmit} className="card bg-white p-6 shadow-xl space-y-4">
//                 <h2 className="text-xl font-bold mb-6 text-center text-gray-800 dark:text-white">Update Doctor Profile</h2>
...
//             <form onSubmit={handlePasswordSubmit} className="card bg-white p-6 shadow-xl space-y-4">
//                 <h2 className="text-xl font-bold text-center text-gray-800 dark:text-white">Update Password</h2>
