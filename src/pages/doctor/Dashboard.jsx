...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        const res = await axiosInstance.get("/api/doctor/me", {
          headers: {
    ...
    const fetchCountAppointments = async () => {
      try {
        const res = await axiosInstance.get("/api/doctor/appoinment-count", {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
    ...
    const fetchAppointments = async () => {
      try {
        const res = await axiosInstance.get("/api/doctor/appointment/today", {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
